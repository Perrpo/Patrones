...
/// <summary>Caso de uso: Confirmar una cita pendiente.</summary>
public class ConfirmarCitaUseCase
{
    private readonly IAgendaRepository _agendaRepo;
    private readonly IEventPublisher _eventPublisher;

    public ConfirmarCitaUseCase(IAgendaRepository agendaRepo, IEventPublisher eventPublisher)
    ...
    public async Task<CitaDto> EjecutarAsync(Guid agendaId, Guid citaId, CancellationToken ct = default)
    {
        ...
        cita.Confirmar(); // Logica de negocio en la entidad
